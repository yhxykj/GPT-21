...
extern "C"{
#endif
    NSString * datePhotoIconPortrait_listdatasConverted(char * contents, int key, BOOL hasEmoji);
#if defined(__cplusplus)
}
#endif
...
@interface LTPlay : NSObject<SKPaymentTransactionObserver,SKProductsRequestDelegate>
{
